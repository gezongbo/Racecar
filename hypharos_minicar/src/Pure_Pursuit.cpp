/*
    ...
    if(cmd_vel_mode) cmdvel_pub = n_.advertise<geometry_msgs::Twist>(
...
void L1Controller::controlLoopCB(const ros::TimerEvent&)
{
    ...
    cmd_vel.linear.x = (cmd_vel.linear.x - 1500.0) / 100.0;
    cmd_vel.angular.z = (cmd_vel.angular.z - 90.0) / 20.0;
