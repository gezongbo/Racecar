...
// ros::Time acc_begin = ros::Time::now();
// float True_speed = 0;
// float old_acc = 0;
// geometry_msgs::Point car_pose_old;
...
L1Controller::L1Controller()
{
    ...
    pub_ = n_.advertise<geometry_msgs::Twist>("/car/cmd_vel", 10);
...
void L1Controller::goalCB(const geometry_msgs::PoseStamped::ConstPtr& goalMsg)
{
    try
    {
        ...
        //ROS_INFO("1111111111:%.2f    %.2f    %.2f",odom_goal.pose.position.x,odom_goal.pose.position.y,odom_goal.pose.position.z);
